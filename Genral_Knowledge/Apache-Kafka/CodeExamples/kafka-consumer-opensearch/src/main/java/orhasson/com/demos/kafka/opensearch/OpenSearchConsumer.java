package orhasson.com.demos.kafka.opensearch;
...
//        String connString = "https://c9p5mwld41:45zeygn9hy@kafka-course-2322630105.eu-west-1.bonsaisearch.net:443";
    ...
    private static KafkaConsumer<String, String> createKafkaConsumer() {
        ...
        properties.setProperty(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, "false"); // Only if commit manually after consuming
        properties.setProperty("security.protocol", "SASL_SSL");
        properties.setProperty("sasl.jaas.config", "ConduktorCredentials");
